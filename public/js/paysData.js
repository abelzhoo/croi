...
region['Antananarivo'] = '|Itasy|Analamanga||Vakinankaratra|Bongolava';
region['Fianarantsoa'] = '|Amoron\'i Mania||Haute Matsiatra|Vatovavy-Fitovinany|Atsimo-Atsinanana|Ihorombe';
region['Toamasina'] = '|Alaotra-Mangoro||Atsinanana|Analanjirofo';
region['Toliara'] = '|Menabe||Atsimo-Andrefana|Androy|Anôsy';
region['Mahajanga'] = '|Melaky||Betsiboka|Boeny|Sofia';
region['Antsiranana'] = '|Sava||Diana';

//District
var district = Object();

district['Analamanga'] = '|AMBOHIDRATRIMO||ANDRAMASINA|ANJOZOROBE|ANKAZOBE|ANTANANARIVO-ATSIMONDRANO|ANTANANARIVO-AVARADRANO|ANTANANARIVO-I|ANTANANARIVO-II|ANTANANARIVO-II|ANTANANARIVO-IV|ANTANANARIVO-V|MANJAKANDRIANA';
district['Bongolava'] = '|FENOARIVOBE||TSIROANOMANDIDY';
district['Itasy'] = '|ARIVONIMAMO||MIARINARIVO|SOAVINANDRIANA|';
district['Vakinakaratra'] = '|AMBATOLAMPY||ANTANIFOTSY|ANTSIRABE I|ANTSIRABE II|BETAFO|FARATSIHO|MANDOTO';
district['Diana'] = '|AMBANJA|AMBILOBE||ANTSIRANANA I|ANTSIRANANA II|NOSY-BE';
district['Sava'] = '|ANDAPA|ANTALAHA||SAMBAVA|VOHEMAR';
district['Amoron i mania'] = '|AMBATOFINANDRAHANA||AMBOSITRA|FANDRIANA|MANANDRIANA';
district['TSIMO-ATSINANANA'] = '|TSIMO-ATSINANANA||FARAFANGANA|MIDONGY SUD|VANGAINDRANO';
district['HAUTE MATSIATRA'] = '|VONDROZO||AMBALAVAO|AMBOHIMAHASOA|FIANARANTSOA|ISANDRA|IKALAMAVONY|VOHIBATO|LALANGINA';
district['Ihorombe'] = '|IAKORA||IHOSY|IVOHIBE';
district['VATOVAVY-FITOVINANY'] = '|IFANADIANA||IKONGO|MANAKARA|MANANJARY|NOSY VARIKA|VOHIPENO';
district['Betsiboka'] = '|KANDREHO|MAEVATANANA|TSARATANANA';
district['Boeny'] = '|AMBATO BOENI|MAHAJANGA I|MAHAJANGA II|MAROVOAY|MITSINJO|SOALALA';
district['Melaky'] = '|AMBATOMAINTY||ANTSALOVA|BESALAMPY|MAINTIRANO|MORAFENOBE';
district['Sofia'] = '|ANALALAVA||ANTSOHIHY|BEALANANA|BEFANDRIANA NORD|MAMPIKONY|MANDRITSARA|PORT-BERGE';
district['ALAOTRA-MANGORO'] = '|AMBATONDRAZAKA||AMPARAFARAVOLA|ANDILAMENA|ANOSIBE AN ALA|MORAMANGA';
district['Analanjorofo'] = '|FENERIVE EST||MANANARA-NORD|MAROANTSETRA|SAINTE MARIE|SOANIERANA IVONGO|VAVATENINA';
district['ATSINANANA'] = '|ANTANAMBAO MANAMPONTSY||BRICKAVILLE|MAHANORO|MAROLAMBO|TOAMASINA I|TOAMASINA II|VATOMANDRY';
district['Androy'] = '|AMBOVOMBE ANDROY ||BEKILY|BELOHA ANDROY|TSIHOMBE';
district['Anosy'] = '|AMBOASARY SUD||BETROKA|TAOLANARO';
district['ATSIMO-ANDREFANA'] = '|AMPANIHY OUEST||ANKAZOABO SUD|BENENITRA|BEROROHA|BETIOKY SUD|MOROMBE|SAKARAHA|TOLIARY I|TOLIARY II';
district['Menabe'] = '|BELO SUR TSIRIBIHINA||MAHABO|MANJA|MIANDRIVAZO|MORONDAVA';

//Commune

var commune = Object();
commune['Ambohidratrimo'] = '|AMBATO||AMBATOLAMPY|AMBOHIDRATRIMO|AMBOHIMANJAKA|AMBOHIMPIHAONANA|AMBOHITRIMANJAKA|AMPANGABE|AMPANOTOKANA|ANJANADORIA|ANOSIALA|ANTANETIBE MAHAZAZA|ANTEHIROKA|ANTSAHAFILO|AVARATSENA|FIADANANA|IARINARIVO|IVATO|MAHABO|MAHEREZA|MAHITSY|MANANJARA|MANJAKAVARADRANO|MERIMANDROSO|TALATAMATY';
commune['Andramasina'] = '|ALAROBIA VATOSOLA|ALATSINAINY BAKARO|AMBOHIMIADANA|ANDOHARIANA|ANDRAMASINA|ANOSIBE TRIMOLOHARANO|ANTOTOHAZO|FITSINJOVANA BAKARO|MANDROSOA|SABOTSY AMBOHITROMBY|SABOTSY MANJAKAVAHOAKA|TANKAFATRA|ANJOMA FALIARIVO|MORARANO SOAFIRAISANA';
commune['Anjozorobe'] = '|ALAKAMISY|AMBATOMANOINA|AMBOASARY|AMBOHIBARY|AMBOHIMANARINA MAROVAZA|AMBOHIMIRARY|AMBONGAMARINA|AMPARATANJONA|ANALAROA|ANDROVAKELY|ANJOZOROBE|ANTANETIBE|BELANITRA|BERONONO|BETATAO|MANGAMILA|MAROTSIPOY|TSARASOATRA ANDANONA|ANDRANOMISA';
commune['Ankazobe'] = '|AMBOHITROMBY|AMBOLOTARAKELY|ANKAZOBE|ANTAKAVANA|ANTOTOHAZO|FIADANANA|FIHAONANA|KIANGARA|MAHAVELONA|MARONDRY|MIANTSO|TALATA-ANGAVO|TSARAMASOANDRO|MANGASOAVINA|ANDRANOMIELY SUD';
commune['Antananarivo-Atsimondrano'] = '|OALAKAMISY FENOARIVO||OALAKAMISY FENOARIVO|AMBALAVAO|AMBATOFAHAVALO|AMBAVAHADITOKANA|AMBAVAHADITOKANA|AMBOHIJANAKA|AMPAHITROSY|AMPANEFY|AMPITATAFIKA|ANDOHARANOFOTSY|ANDRANONAHOATRA|ANDROHIBE|ANKADIMANGA|ANKARAOBATO|ANOSIZATO ANDREFANA|ANTANETIKELY|BEMASOANDRO|BONGATSARA|FENOARIVO|FIOMBONANA|ITAOSY|SOALANDY|SOAVINA|TANJOMBATO|TSIAFAHY';
commune['Antananarivo-Avaradrano'] = '|ALASORA||AMBOHIMALAZA MIRAY|AMBOHIMANAMBOLA|AMBOHIMANGA ROVA|AMBOHIMANGAKELY|ANJEVA GARA|ANKADIKELY ILAFY|ANKADINANDRIANA|FIAFERANA|MANANDRIANA|MASINDRAY|SABOTSY NAMEHANA|TALATA VOLONONDRY|VILIAHAZO|ANOSY AVARATRA|AMBOHITRABIBY|'
commune['Fenoarivobe'] = '|AMBATOMAINTY SUD||AMBOHITROMBY|FENOARIVOBE|FIRAVAHANA|KIRANOMENA|MAHAJEBY|MORARANO MARITAMPONA|TSINJOARIVO|MANGATANY|ANDRIAMPOTSY';
commune['Tsiroanomandidy'] = '|AMBALANIRANA||AMBARARATABE|AMBATOLAMPY|ANKADINONDRY SAKAY|ANKERANA NORD|ANOSY|BELOBAKA|BEMAHATAZANA|BEVATO|FIERENANA|MAHASOLO|MAROHARONA|MARITAMPONA|MIANDRARIVO|SOANIERANA|TSINJOARIVO-IMANGA|TSIROANOMANDIDY FIHAONA|TSIROANOMANDIDY VILLE|ANTSAHALAVA|FIADANANTSOA';
commune['Arivonimano'] = '|ALAKAMISIKELY||AMBATOMANGA|AMBATOMIRAHAVAVY|AMBOANANA|AMBOHIMANDRY|AMBOHIMASINA|AMBOHIPANDRANO|AMBOHITRAMBO|AMPAHIMANGA|ANDRANOMIELY|ANTAMBOLO|ANTENIMBE|ARIVONIMAMO|ARIVONIMAMO II|IMERINTSIATOSIKA|MAHATSINJO EST|MANALALONDO|MAROFANGADY|MIANDRANDRA|MIANTSOARIVO|MORAFENO|MORARANO|TALATA TSIMADILO';
commune['Miarinarivo'] = '|ALATSINAINIKELY||AMBATOMANJAKA|ANALAVORY|ANDOLOFOTSY|ANDOLOFOTSY|ANTOBY EST|MANAZARY|MANDIAVATO|MIARINARIVO|MIARINARIVO II|SAROBARATRA|SOAMAHAMANINA|SOAVIMBAZAHA|ZOMA BEHALOKA';
commune['Soavinandriana'] = '|AMBATOASANA CENTRE ||AMBEROMANGA|AMPARAKY|AMPARIBOHITRA|AMPARY|AMPEFY|ANKARANANA|ANKISABE|ANTANETIBE|DONDONA|MAHAVELONA|MANANASY|MASINDRAY|SOAVINANDRIANA|TAMPONALA|AMBOHIDANERANA';

commune['Antananarivo-i'] = '|COMMUNE URBAINE ANTANANARIVO I'
commune['Antananarivo-ii'] = '|COMMUNE URBAINE ANTANANARIVO II'
commune['Antananarivo-iii'] = '|COMMUNE URBAINE ANTANANARIVO III'
commune['Antananarivo-iv'] = '|COMMUNE URBAINE ANTANANARIVO IV'
commune['Antananarivo-v'] = '|COMMUNE URBAINE ANTANANARIVO V'
commune['Antananarivo-vi'] = '|COMMUNE URBAINE ANTANANARIVO VI'

commune['Manjakandriana'] = '|ALAROBIA||AMBANITSENA|AMBATOLOANA|AMBATOMANGA|AMBATOMENA|AMBOHIBAO SUD|AMBOHIBARY|AMBOHITRANDRIAMANITRA|AMBOHITROLOMAHITSY|AMBOHITRONY|AMBOHITSEHENO|AMPANEVA|ANJEPY|ANJOMA BETOHO|ANKAZODANDY|ANTSAHALALINA|MANJAKANDRIANA|MANTASOA|MERIKANJAKA|MERIKANJAKA|MIADANANDRIANA|NANDIHIZANA CARION|RANOVAO|SADABE|SAMBAINA|SOAVINANDRIANA';


commune['Ambatolampy'] = '|AMBATOLAMPY||AMBATONDRAKALAVAO|AMBODIFARIHY|AMBOHIMPIHAONANA|ANDRANOVELONA|ANDRAVOLA VOHIPENO|ANDRIAMBILANY|ANTAKASINA|ANTANAMALAZA|ANTANIMASAKA|ANTSAMPANDRANO|BEHENJY|BELAMBO FIRAISANA|MANJAKATOMPO|MORARANO|SABOTSY NAMATOANA|TSIAFAJAVONA ANKARATRA|TSINJOARIVO|ANDRIANTSIVALANA';
commune['Antanifotsy'] = '|AMBATOLAHY||AMBATOMIADY|AMBATOTSIPIHANA|AMBODIRIANA|AMBOHIMANDROSO|AMBOHITOMPOINA|AMPITATAFIKA|ANDRANOFITO|ANTANIFOTSY|ANTSAHALAVA|ANTSAMPANDRANO|BELANITRA|ANJAMANGA|SOAMANANDRARINY';
commune['Antsirabe-i'] = '|ANTSIRABE';
commune['Antsirabe-ii'] = '|ALAKAMISY||ALATSINAINY IBITY|AMBANO|AMBATOMENA|AMBOHIBARY|AMBOHIDRANANDRIANA|AMBOHIMIARIVO|AMBOHITSIMANOVA|ANDRANOMANELATRA|ANTANAMBAO|ANTANIMANDRY|ANTSOATANY|BELAZAO|MANANDONA|MANDROSOHASINA|MANGARANO|SAHANIVOTRY MANANDONA|SOANINDRARINY|TSARAHONENANA SAHANIVOTRA|VINANINKARENA';
commune['Betafo'] = '|ALAKAMISY ANATIVATO||ALAKAMISY ANATIVATO|ALAROBIA BEMAHA|AMBATONIKOLAHY|AMBOHIMANAMBOLA|AMBOHIMASINA|ANDRANOMAFANA|ANDREMBESOA|MANOHISOA|MANDRITSARA|ANOSIARIVO MANAPA|SOAVINA|ANTOHOBE|ANTSOSO|BETAFO|TRITRIVA|MAHAIZA|INANANTONANA';
commune['Faratsiho'] = '|AMBOHIBORONA||ANDRANOMIADY|ANTSAMPANIMAHAZO|FARATSIHO|MIANDRARIVO|RAMAINANDRO|VALABETOKANA|FARAVOHITRA|VINANINONY SUD';
commune['Mandoto'] = '|MANDOTO||VASIANA|ANTANAMBAO AMBARY|BETSOHANA|ANKAZOMIRIOTRA|VINANY|ANJOMA RAMARTINA|FIDIRANA|MAROMANDRAY';

commune['Ambanja'] = '|AMBALAHONKO||AMBALIHA|AMBANJA|AMBODIMANGA RAMENA|AMBOHIMARINA|AMBOHIMENA|AMBOHITRANDRIANA|ANKATAFA|ANKINGAMELOKA|ANOROTSANGANA|ANTAFIAMBOTRY|ANTRANOKARANY|ANTSAKOAMANONDRO|ANTSATSAKA|ANTSIRABE|BEMANEVIKA HAUT-SAMBIRANA|BEMANEVIKA OUEST|BENAVONY|DJANGOA|MAEVATANANA|MAHERIVARATRA|MAROTOLANA|MAROVATO|ANTSAHABE CENTRE';
commune['Ambilobe'] = '|AMBAKIRANO||AMBARAKARAKA|AMBATOBEN \'ANJAVY|AMBILOBE|AMBODIBONARA|AMPONDRALAVA|ANABORANO IFASY|ANJIABE HAUT|ANTSARAVIBE|ANTSOHIMBONDRONA|BERAMANJA|BETSIAKA|MANAMBATO|MANTALY|TANAMBAO MARIVORAHONA|ANTANABE|SIRAMA';
commune['Antsiranana-I'] = '|ANTSIRANANA';
commune['Antsiranana-II'] = '|AMBONDRONA||ANDRAFIABE|ANDRANOFANJAVA|ANDRANOVONDRONINA|ANIVORANO NORD|ANKARONGANA|ANKETRAKABE|ANTANAMITARANA|ANTSAHAMPANO|ANTSALAKA|ANTSOHA|BOBAKILANDY|BOBASAKOA|JOFFRE-VILLE|MAHALINA|MAHAVANONA|MANGAOKA|MOSOROLAVA|RAMENA|SADJOAVATO|SAKARAMY|ANTSAKOABE|AMBOLOBOZOBE';
commune['Anosy-Be'] = '|AMBATOZAVAVY||DZAMANDZAR|AMPANGORIANA|BEMANONDROBE|HELL-VILLE';

commune['Andapa'] = '|AMBALAMANASY II||AMBODIANGEZOKA|AMBODIMANGA I|ANDAPA|ANDRAKATA|ANDRANOMENA|ANJIALAVABE|ANJIALAVABE|ANOVIARA|ANTSAHAMENA|BEALAMPONA|BELAOKA LOKOHO|BELAOKA MAROVATO|BELAOKA MAROVATO|DOANY|MAROVATO|MATSOHELY|TANANDAVA|AMBODIDIVAINA|ANDASIBE KOBAHINA|AMBALAVELONA';
commune['Antalaha'] = '|AMBALABE||AMBINANIFAHO|AMBOHITRALANANA|AMPAHANA|AMPANAVOANA|AMPOHIBE|ANDAMPY|ANTALAHA|ANTANANANAMBO|ANTOMBANA|ANTSAHANORO|ANTSAMBALAHY|LANJARIVO|MAROFINARITRA|SARAHANDRANO|VINANIVAO|SAHANTAHA|MANAKAMBAHINY ANKAVIA';
commune['Sambava'] = '|AMBATOAFO||AMBOANGIBE|AMBODIAMPANA|AMBODIVOARA|AMBOHIMALAZA|AMBOHIMITSINJO|ANALAMAHO|ANDRAHANJO|ANDRATAMARINA|ANDRATAMARINA|ANDREMBONA|ANJANGOVERATRA|ANJIALAVA|ANJINJAOMBY|ANTINDRA|ANTSAHAVARIMBE|ANTSAMBAHARO|BEMANEVIKA|BEVONOTRA|FARAHALANA|MAROAMBIHY|MAROGAONA|MAROJALA|MORAFENO|NOSIARINA|SAMBAVA|TANAMBAON \'I DAOUD|ANDAPABE|MAHASOA';
commune['Vohemara'] = '|AMBALASATRANA||AMBINANIN \' ANDRAVORY|AMBORIALA|AMBORIALA|AMPISIKINANA|AMPONDRA|ANDRAFAINKONA|ANDRAVORY|AMBODISAMBALAHY|ANTSIRABE NORD|BELAMBO|BOBAKINDRO|DARAINA|FANAMBANA|MAROMOKOTRA LOKY|MILANOA|NOSIBE|TSARABARIA|VOHEMAR';

commune['Ambatofinandrahana'] = '|AMBATOFINANDRAHANA||AMBATOMIFANONGOA|AMBONDROMISOTRA|AMBOROMPOTSY|FENOARIVO|ITREMO|MANDROSONORO|MANGATABOAHANGY|SOAVINA';
commune['Ambositra'] = '|ALAKAMISY AMBOHIJATO||AMBALAMANAKANA|AMBATOFITORAHANA|AMBINANINDRANO|AMBOHIMITOMBO I|AMBOHIMITOMBO II|AMBOSITRA|AMBOSITRA BANLIEUE|ANDINA|ANKAZOAMBO|ANTOETRA|FAHIZAY|IHADILANANA AMBOHINAMBO|ILAKA CENTRE|IMERINA IMADY|IVATO|IVONY MIARAMIASA|KIANJANDRAKEFINA|MAHAZINA AMBOHIPIERENANA|MAROSOA|SAHATSIHO AMBOHIMANJAKA|TSARASAOTRA|VOHIDAHY|AMBOHIPERIVOANA|ANKAZOTSARARAVINA';
commune['Fandriana'] = '|ALAKAMISY AMBOHIMAHAZO||ANKARINORO|BETSIMISOTRA|FANDRIANA|IMITO|MAHAZOARIVO|MIARINAVARATRA|MILAMAINA|SAHAMADIO FISAKANA|SANDRANDAHY|TATAMALAZA|TSARAZAZA|SOANAKAMBANA|ISANDRANDAHY AMBONY';
commune['Manandriana'] = '|AMBATOMARINA||AMBOHIMILANJA|AMBOHIPO|AMBOVOMBE CENTRE|ANDAKATANY|ANJOMA NANDIHIZANA|ANJOMAN \' ANKONA|TALATA VOHIMENA|VINANY ANDAKATANIKELY|SOATANANA|ILANJANA';
commune['Befotaka-Atsimo'] = '|ANTANINARENINA||ANTONDAMBE|BEFOTAKA SUD|BEHARENA|BEKOFAFA SUD|MAROVITSIKA SUD|RANOTSARA SUD|ANTOKOBORITELO|INOSY';
commune['Farafangana'] = '|AMBALATANY||AMBALAVATO NORD|AMBALAVATO/ANTEVATO|AMBOHIGOGO|AMBOHIMANDROSO|AMPOROFORO|ANKARANA MIRAIHINA|ANOSIVELO|ANOSY TSARARAFA|ANTSERANAMBE|ANTSERANAMBE|EFATSY ANANDROZA|ETROTROKA|EVATO|FARAFANGANA|FENOARIVO|IABOHAZO|IHOROMBE|IVANDRIKA|MAHABO MANANIVO|MAHAFASA CENTRE|MAHAVELO|MAHERIRATY|MANAMBOTRA SUD|MAROVANDRIKA|NAMOHORA IABORANO|SAHAMADIO|TANGAINONY|TOVONA|VOHILENGO|VOHIMASY|VOHITROMBY|VOHILAVAN \'I MANAMPATRANA|';
commune['Midongy-Sud'] = '|ANDRANOLALINA||ANKAZOVELO|IVONDRO EX-LAVARATY|NOSIFENO EX-MIDONGY SUD|SOAKIBANY|ZARA EX-MALIORANO|BEVAHO';
commune['Vangaindrano'] = '|AMBATOLAVA||AMBONGO|AMPARIHY EST|AMPASIMALEMY|AMPATAKA|ANILOBE|BEKARAOKY|BEMA|BEVATA|VOHIPAHO|FENOAMBANY|IARA|ISAHARA|KARIMBARY|LOHAFARY|LOPARY|MANAMBONDRO|MAROKIBO|MASIANAKA|MATANGA|RANOMENA|SANDRAVINANY|SOAMANOVA|TSIANOFANA|TSIATELY|VANGAINDRANO|VATANATO|VOHIMALAZA|MAHABE|FONILAZA';
commune['Vondrozo'] = '|AMBOHIMANA||ANANDRAVY|ANDAKANA|ANTOKONALA|IAMONTA|IVATO|KARIANGA|MAHATSINJO|MAHAVELO|MAHAZOARIVO|MANAMBIDALA|MANATO|MOROTEZA|VOHIBOREKA|VOHIMARY|VONDROZO|AMBODIRANO|ANDOHARANO';
commune['Ambalavao'] = '|AMBALAVAO||AMBINANINDOVOKA|AMBINANIROA|AMBOHIMAHAMASINA|AMBOHIMANDROSO|ANDRAINJATO|ANJOMA|ANKARAMENA|BESOA|FENOARIVO|IARINTSENA|KIRANO|MAHAZONY|MANAMISOA|MIARINARIVO|SENDRISOA|VOHITSAOKA|NAMOLY|VOLAMENA|AMBALAKINDRESY|AMBATOSOA|AMBOHIMAHASOA|AMBOHINAMBOARINA|AMPITANA|ANKAFINA TSARAFIDY|ANKERANA|BEFETA|CAMP ROBIN|FIADANANA|ISAKA|IKALALAO|MANANDROY|MORAFENO|SAHATONA|SAHAVE|VOHIPOSA|VOHITRARIVO';
commune['Fianarantsoa'] = '|ANDRAINJATO-NORD||LAZANA|MANOLAFAKA|VATOSOLA|VILLE BASSE|VILLE HAUTE';
commune['Isandra'] = '|AMBALAMIDERA II||AMBONDRONA|ANDOHARANOMAITSO|ANJOMA ITSARA|ANKARINARIVO MANIRISOA|FANJAKANA|IAVINOMBY VOHIBOLA|ISORANA|MAHAZOARIVO|NASANDRATRONY|SOATANANA|ANDREAMALAMA|AMBALAMIDERA AMBOHIMANA';
commune['Ikalamavony'] = '|AMBATOMAINTY||FITAMPITO|IKALAMAVONY|MANGIDY|SAKAY TANAMARINA|SOLILA|TANAMARINA BEKISOPA|TSITONDROINA';
commune['Vohibato'] = '|ALAKAMISY ITENINA||ANDRANOMIDITRA|ANDRANOVORIVATO|MAHADITRA|MAHASOABE|MANEVA|SOAINDRANA|TALATA AMPANO|VINANITELO|VOHIMARINA|VOHITRAFENO|IHAZOARA|ANKAROMALAZA|ANKAROMALAZA|LAMOSINA|ANJANOMANANA TSIMANAVA';
commune['Lalangina'] = '|ALAKAMISY AMBOHIMAHA||IALAMARINA|AMBALAKELY|AMBALAMAHASOA|ANDRAINJATO CENTRE|ANDRAINJATO EST|ANDROY|FANDRANDAVA|IALANANINDRO|IVOAMBA|MAHATSINJONY|SAHAMBAVY|TAINDAMBO|SAFATA|AMPATSY AMPANGABE|VINANINORO ANDREFANA';
commune['Iakora'] = '|BEGOGO||IAKORA|RANOTSARA NORD|ANDRANOMBAO';
commune['Ihosy'] = '|VOLAMBITA|AMBATOLAHY|AMBIA|ANALALIRY|ANALAVOKA|ANDIOLAVA|ANKILY|ANTSOHA|IHOSY|ILAKAKA-BE|MENAMATY-ILOTO|IRINA|MAHASOA|RANOHIRA|SAHAMBANO|SAKALALINA|SATROKALA|SOAMATASY|TOLOHOMIADY|ZAZAFOTSY|ANDOHAN \'ILAKAKA';
commune['Ivohibe'] = '|ANTAMBOHOBE||IVOHIBE|IVONGO|MAROPAIKA|KOTIPA|ANTARAMENA';
commune['Ifanadiana'] = '|AMBOHIMANGA SUD||AMBOHIMIERA|ANALAMPASINA|ANDRORANGAVOLA|ANTARETRA|FASINTSARA|KELILALINA|MAROHARATRA|MAROTOKO|RANOMAFANA|TSARATANANA|AMPASINAMBO|AMBIABE';
commune['Ikongo'] = '|AMBATOFOTSY||AMBINANITROMBY|AMBOHIMISAFY|AMBOLOMADINIKA|ANKARIMBELO|ANTODINGA|BELEMOKA|IFANIREA|IKONGO|KALAFOTSY|MANAMPATRANA|MAROMIANDRA|SAHALANONA|TANAKAMBANA|TOLONGOINA|TSIFENOKATAKA|ANDEFAPONY';
commune['Manakara'] = '|AMBAHATRAZO|AMBAHIVE|AMBALAROKA|AMBALAVERO|AMBANDRIKA|AMBILA|AMBOANJO|AMBOHITSARA-M|AMBORONDRA|AMBOTAKA|AMPASIMANJEVA|AMPASIMBORAKA|AMPASIPOTSY SUD|ANALAVORY|ANOROMBATO|ANTEZA|BEKATRA|BETAMPONA|FENOMBY|KIANJANOMBY|LOKOMBY|MAHABAKO|MAHAMAIBE|MANAKARA';

var fkt = Object();
//fkt AMBOHIDRATRIMO
fkt['Ambato'] = '|AMBATO||AMBANIMASO|AMBATOHARANANA|AMBODIMANGA|AMBOHIJORERY|AMBOHIMITSINJORANO|AMPANOTOKANA|ANKADIBE|ANKAFOTRA|ANTANETIBE|ANTSAHALAVA|MIARAMASOANDRO|MAHITSITADY|SOALOKA|VATOVANDANA';
fkt['Ambatolampy'] = '|AMBATOLAMPY||AMBOHIDAVA|AMBOHIMARINA|ANJOMAKELY|AVARAJOZORO|AMBODIFASINA|SOAVINARIVO|AMBOHINOME';
fkt['Ambohidratrimo'] = '|AMBOHIDRATRIMO||ANTSIMOMPARIHY|SOAMANANETY|AMBOHIDEHILAHY|AMBOVO|AMBOHITSIROA EST|AMBODISAHA|AMPANATAOVANA|ANTOHIBE';
fkt['Ambohimanjaka'] = '|AMBOHIMANJAKA||AMBOHIDRAZAKA|AMBOHIMARINA OUEST|AMBOHITRINIBE|ANDRANOMASINA|ANJEHIVOLA|ANKONDODONA';
fkt['Ambohimpihaonana'] = '|AMBOHIMPIHAONANA||AMBATOTELO|AMBOHIBAO|AMPARAFARAVATO|ANKADIFOTSY|ANTANAMBAO|MAHARIDAZA|AVARATRIMANGABE|AMBOHIMITSINJO|TSARAHONENANA|AMPAHIMARO';
fkt['Ambohitrimanjaka'] = '|MAHITSY NORD||MAHITSY FIRAISANA|LEHILAVA|AMPAHIBE|FIAKARANA|ANTSAHAFOHY|AMBODIVOANJO|AMBATOLAMPY SUD|ANTSAHAVOLO|NAMORANA|AMPIRIAKA|AMBOHIMANANJO|ANDRINGITANA|AMBODIVONA|IKOPAKELY|ANTANETIBE|ANDRANOMAHITSY|FARAHINDRA|BELOHA|AMBATOLAMPY NORD|ANTSAHAMARINA|MIADANA|ANOSIMANJAKA';
fkt['Ampangabe'] = '|SOAMANJAKA NORD||AMBATOBE|AMBOHIBARY|MANJAKA EST|IKIANJA|AMBOHIMIANDRA|AMPANDRILAZA|AMBOHIDRENY|ANTANANAMBONY|FALIHAVANA|ANAKAKONDRO';
fkt['Ampanotokana'] = '|AMPANOTOKANA||AMBARIBE|AMBATOMIRAHAVAVY|AMBATOMITSANGANA|AMBOHIBOAHANGY|AMBOHIKELY|AMBOHIMIADANA|AMBOHITRINILANITRA|AMBONIAVARATRA|AMPANATAOVANA SUD|AMPANATAOVANA NORD|AMPARIBE|ANDOHANIMASINA|ANDRALANTOINA|ANDROHIBE|ANTANETIBE NORD|ANTANETY|ANTSAHARATSY|ANTSAMPANIMAHAZO|ANTSAONJOMANGA|BELANITRA|BEMASOANDRO NORD|ANOSIVOLAKELY|MIADAPAHONINA|MORARANO|SOAVIKANJAKA|VANGAINA|SOAVIMALAZA|BEMASOANDRO SUD';
fkt['Anjanadoria'] = '|ANJANADORIA||AMBOHIMARINA|AMBONIRIANA|AMBOHIMANATRIKA|AMPATAKA|ANDRANOMAINTSO|ANTAMBOHO|ANTETEZANKAZO|BEVATO|MADIORANO|MANANKASINA|MANDROSOA EST|MERINAVARATRA|SATROKODITRA';
fkt['Anosiala'] = '|AMBOHIPANASINA||AMBATOMENA|FIAKARANA|MANJAKAZAFY|LAVAHITSINY|TSARAMANDROSO NAMONTANA|AMBOHITSIMELOKA|AMBOHITRINIBE|ANJANAMASINA|ANKAZO ANDRIAMPIANIANANA|AMBOHITSIROA|ANDRAKAJA|AMBOHIPIARA|SOAMANANDRAY|TSARAHONENANA IVOANJO|MANDROSOA|AVARABOHITRA';
//fkt FENOARIVOBE
fkt['AMBATOMAINTY SUD'] = '|';

const getCountry = () => {
    let datas = [];
    for (const countrie in countries) {
        countries[countrie].split('|').filter(data => {
            if (data !== "") {
                datas.push(data)
            }
        })
...
const getProvince = (data) => {
    ...
    if (data) {
        if (city_states[data]) {
            let dataOne = city_states[data].split('|');
            dataOne.filter(prov => {
                if (prov !== "") {
                    datas.push(prov)
                }
...
const getDistrict = (data) => {
    let datas = [];
    let words = capitalizer(data);
    if (words) {
        if (district[words]) {
            let dataOne = district[words].split('|');
            dataOne.filter(dist => {
                if (dist !== "") {
                    datas.push(capitalizer(dist));
                }
            })
        }
    }
...
const getCommune = (data) => {
    let datas = [];
    let words = capitalizer(data);
    if (words) {
        if (commune[words]) {
            let dataOne = commune[words].split('|');
            dataOne.filter(com => {
                if (com !== "") {
                    datas.push(capitalizer(com));
                }
            })
        }
    }
...
const getQuartier = (data) => {
    let datas = [];
    let words = capitalizer(data);
    if (words) {
        if (fkt[words]) {
            let dataOne = fkt[words].split('|');
            dataOne.filter(fok => {
                if (fok !== "") {
                    datas.push(capitalizer(fok));
                }
            })
        }
    }
